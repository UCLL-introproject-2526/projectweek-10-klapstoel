...
class Speler(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = laad_afbeelding("/Users/arnedeboudt/Desktop/UCLL/introduction project/projectweek/projectweek-10-klapstoel/projectweek-10-klapstoel/space invaders/images/spaceship copy.png", 60, 60, (0, 0, 255))
